...
ALTER TYPE "public"."customer_credit_type" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."credit_note_to_wallet"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."credit_note_to_wallet"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."decrease_stock_on_sale"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
...
ALTER FUNCTION "public"."decrease_stock_on_sale"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."fn_create_sale_from_maintenance"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_sale_id uuid;
...
ALTER FUNCTION "public"."fn_create_sale_from_maintenance"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."fn_maintenance_to_sale"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
    v_sale_id     uuid;
...
ALTER FUNCTION "public"."fn_maintenance_to_sale"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."increase_stock_on_purchase"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
    update public.products
...
ALTER FUNCTION "public"."increase_stock_on_purchase"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."recalculate_purchase_total"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
    v_total       numeric(12,2);
...
ALTER FUNCTION "public"."recalculate_purchase_total"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."recalculate_sale_total"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
    v_subtotal numeric(12,2);
...
ALTER FUNCTION "public"."recalculate_sale_total"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."restore_stock_on_credit_note"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
    if NEW.status = 'completado'
...
ALTER FUNCTION "public"."restore_stock_on_credit_note"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_purchase_status_on_payment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
...
ALTER FUNCTION "public"."update_purchase_status_on_payment"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_sale_status_on_payment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
...
ALTER FUNCTION "public"."update_sale_status_on_payment"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."validate_maintenance_delivery"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $_$
declare
    v_total_pagado numeric(12,2);
...
ALTER FUNCTION "public"."validate_maintenance_delivery"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."credit_notes" (
    ...
    CONSTRAINT "credit_notes_total_check" CHECK (("total" >= (0)::numeric))
);
...
ALTER TABLE "public"."customer_credit" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."maintenance_items" (
    ...
    "created_at" timestamp without time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp without time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "maintenance_items_item_type_check" CHECK (("item_type" = ANY (ARRAY['retail'::"text", 'service'::"text"]))),
    CONSTRAINT "maintenance_items_quantity_check" CHECK (("quantity" > 0)),
    CONSTRAINT "maintenance_items_unit_price_check" CHECK (("unit_price" >= (0)::numeric))
);
...
CREATE TABLE IF NOT EXISTS "public"."maintenance_payments" (
    ...
    "notes" "text",
    "created_at" timestamp without time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "maintenance_payments_amount_check" CHECK (("amount" > (0)::numeric))
);
...
CREATE TABLE IF NOT EXISTS "public"."sales" (
    ...
    "created_at" timestamp without time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "sales_sales_type_check" CHECK (("sales_type" = ANY (ARRAY['retail'::"text", 'service'::"text", 'mixed'::"text"])))
);
...
CREATE INDEX "idx_bicycles_customer" ON "public"."bicycles" USING "btree" ("customer_id");



CREATE INDEX "idx_maintenance_bicycle" ON "public"."maintenance_records" USING "btree" ("bicycle_id");



CREATE INDEX "idx_maintenance_sale" ON "public"."maintenance_records" USING "btree" ("sale_id");
...
CREATE INDEX "idx_sales_date" ON "public"."sales" USING "btree" ("sales_date");
...
CREATE OR REPLACE TRIGGER "trg_bicycles_updated_at" BEFORE UPDATE ON "public"."bicycles" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_decrease_stock_on_sale" AFTER INSERT ON "public"."sale_items" FOR EACH ROW EXECUTE FUNCTION "public"."decrease_stock_on_sale"();



CREATE OR REPLACE TRIGGER "trg_increase_stock_on_purchase" AFTER INSERT ON "public"."purchase_items" FOR EACH ROW EXECUTE FUNCTION "public"."increase_stock_on_purchase"();



CREATE OR REPLACE TRIGGER "trg_maintenance_to_sale" BEFORE UPDATE ON "public"."maintenance_records" FOR EACH ROW EXECUTE FUNCTION "public"."fn_maintenance_to_sale"();



CREATE OR REPLACE TRIGGER "trg_maintenance_updated_at" BEFORE UPDATE ON "public"."maintenance_records" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_recalculate_purchase_total" AFTER INSERT OR DELETE OR UPDATE ON "public"."purchase_items" FOR EACH ROW EXECUTE FUNCTION "public"."recalculate_purchase_total"();



CREATE OR REPLACE TRIGGER "trg_recalculate_sale_total" AFTER INSERT OR DELETE OR UPDATE ON "public"."sale_items" FOR EACH ROW EXECUTE FUNCTION "public"."recalculate_sale_total"();
...
CREATE OR REPLACE TRIGGER "trg_validate_maintenance_delivery" BEFORE UPDATE ON "public"."maintenance_records" FOR EACH ROW EXECUTE FUNCTION "public"."validate_maintenance_delivery"();

ALTER TABLE "public"."maintenance_records" DISABLE TRIGGER "trg_validate_maintenance_delivery";
...
CREATE POLICY "bicycles" ON "public"."bicycles" USING (true);
...
CREATE POLICY "credit_notes_all" ON "public"."credit_notes" USING (true);
...
CREATE POLICY "customer_credit_all" ON "public"."customer_credit" USING (true);
...
CREATE POLICY "maintenance_items all" ON "public"."maintenance_items" USING (true);
...
CREATE POLICY "maintenance_payments_all" ON "public"."maintenance_payments" USING (true);



CREATE POLICY "maintenance_record_all" ON "public"."maintenance_records" TO "authenticated" USING (true);
...
CREATE POLICY "payments_all" ON "public"."payments" USING (true);
...
CREATE POLICY "products_all" ON "public"."products" USING (true);
...
CREATE POLICY "purches_insert" ON "public"."purchases" FOR INSERT WITH CHECK (true);



CREATE POLICY "purches_items_all" ON "public"."purchase_items" USING (true);



CREATE POLICY "purcheses_select" ON "public"."purchases" FOR SELECT USING (true);



CREATE POLICY "sale_item_all" ON "public"."sale_items" USING (true);
...
CREATE POLICY "sale_select" ON "public"."sales" FOR SELECT USING (true);
...
CREATE POLICY "suppliers_all" ON "public"."suppliers" USING (true);
...
GRANT ALL ON TABLE "public"."bicycles" TO "anon";
GRANT ALL ON TABLE "public"."bicycles" TO "authenticated";
GRANT ALL ON TABLE "public"."bicycles" TO "service_role";
...
GRANT ALL ON TABLE "public"."customer_credit" TO "anon";
GRANT ALL ON TABLE "public"."customer_credit" TO "authenticated";
GRANT ALL ON TABLE "public"."customer_credit" TO "service_role";
